...
{
    [ExecuteInEditMode]
    public class PotentialFunctionWall : MonoBehaviour, PotentialManager.IPotential
    {
        ...
        public void ApplyPotential(BufferedRenderTexture renderTexture)
        {
            ...
            _shaderImpl.Block(renderTexture.Read, renderTexture.Write, start, end, height, useMax);
            renderTexture.Swap();
        }
        ...
        public bool IsValid()
        {
            return isActiveAndEnabled && gameObject != null && gameObject.activeInHierarchy;
        }
    }
}
